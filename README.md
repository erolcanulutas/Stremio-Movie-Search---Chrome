...
A Chrome extension that adds a Stremio button next to movie and TV show titles on Google, DuckDuckGo, IMDb and Trakt.tv, letting you open them in Stremio (app or web) with a single click.
